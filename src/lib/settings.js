...
export function shopFormFromSettings(shop) {
  return {
    ...
    sale_document_type: shop?.sale_document_type === "invoice" ? "invoice" : "receipt",
...
export async function saveShopSettings(supabase, values) {
  ...
  const payload = {
    ...
    p_sale_document_type: values.sale_document_type === "invoice" ? "invoice" : "receipt",
    p_invoice_paper_size: values.invoice_paper_size === "A4" ? "A4" : "A5",
    p_invoice_title: text(values.invoice_title, "INVOICE"),
    p_invoice_title_km: text(values.invoice_title_km, "វិក្កយបត្រ"),
    p_invoice_footer: text(values.invoice_footer, "Thank you for your purchase."),
    p_invoice_footer_km: text(values.invoice_footer_km, "សូមអរគុណចំពោះការគាំទ្រ!"),
    p_invoice_show_logo: values.invoice_show_logo !== false,
    p_invoice_show_address: values.invoice_show_address !== false,
    p_invoice_show_contact: values.invoice_show_contact !== false,
    p_invoice_show_tax_id: values.invoice_show_tax_id !== false,
    p_invoice_show_customer: values.invoice_show_customer !== false,
    p_invoice_show_cashier: values.invoice_show_cashier !== false,
    p_invoice_show_received: values.invoice_show_received !== false,
    p_invoice_show_change: values.invoice_show_change !== false,
    p_invoice_show_signatures: values.invoice_show_signatures !== false,
